...
# 12 "./ECU/ecu_layer_init.h"
# 1 "./ECU/KEYPAD/ecu_keypad.h" 1
# 12 "./ECU/KEYPAD/ecu_keypad.h"
# 1 "./ECU/KEYPAD/../../MCAL/GPIO/hal_gpio.h" 1
# 13 "./ECU/KEYPAD/../../MCAL/GPIO/hal_gpio.h"
# 1 "./ECU/KEYPAD/../../MCAL/GPIO/../mcal_std_types.h" 1
# 17 "./ECU/KEYPAD/../../MCAL/GPIO/../mcal_std_types.h"
...
# 1 "./ECU/KEYPAD/../../MCAL/GPIO/../../MCAL/mcal_std_libraries.h" 1
# 12 "./ECU/KEYPAD/../../MCAL/GPIO/../../MCAL/mcal_std_libraries.h"
...
# 12 "./ECU/KEYPAD/../../MCAL/GPIO/../../MCAL/mcal_std_libraries.h" 2
...
# 13 "./ECU/KEYPAD/../../MCAL/GPIO/../../MCAL/mcal_std_libraries.h" 2
# 14 "./ECU/KEYPAD/../../MCAL/GPIO/hal_gpio.h" 2
# 33 "./ECU/KEYPAD/../../MCAL/GPIO/hal_gpio.h"
typedef enum{
    GPIO_PORTA,
    GPIO_PORTB,
    GPIO_PORTC,
...
typedef struct{
    pin_config_t keypad_row[4];
    pin_config_t keypad_col[4];
}keypad_t;
...
# 13 "./ECU/ecu_layer_init.h" 2

# 1 "./ECU/LCD/ecu_lcd.h" 1
# 35 "./ECU/LCD/ecu_lcd.h"
typedef struct{
    pin_config_t rs;
    pin_config_t en;
    pin_config_t data[8];
...
extern led_t led_wrong;
extern led_t led_correct;
extern lcd_8bit_mode lcd;
...
void main(void) {
    ...
    while(1){
        ...
        if(keypad_value == secret_value){
            ...
            lcd_8bit_send_command(&lcd, 0x1C);
            _delay((unsigned long)((15)*(80000000UL/4000.0)));
            lcd_8bit_send_command(&lcd, 0x18);
            _delay((unsigned long)((15)*(80000000UL/4000.0)));
